...
class RowColMap(RCMap):
    ...
    def preimages_of_rows_and_cols(self, cols : Iterable[int], rows : Iterable[int]) -> Tuple[set[int], set[int]]:
    ...
    def images_of_rows_and_cols(self, cols : Iterable[int], rows : Iterable[int]) -> Tuple[set[int], set[int]]:
