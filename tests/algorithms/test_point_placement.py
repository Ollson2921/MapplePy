    ...
    assert list(
        ...
        MappedTiling(
            ...
            (
                (
                    Parameter(
                        Tiling((), (), (2, 2)), RowColMap({0: 2, 1: 2}, {0: 3, 1: 3})
                    ),
                    Parameter(
                        Tiling(
                            (
                ...
                (
                    ...
                    Parameter(
                        ...
                        RowColMap({0: 0, 1: 1, 2: 2, 3: 2}, {0: 0, 1: 0, 2: 1, 3: 2}),
                    ),
                    Parameter(
                        Tiling(
                            (
                    ...
                    Parameter(
                        ...
                        RowColMap({0: 0, 1: 0, 2: 1, 3: 2}, {0: 0, 1: 0, 2: 1, 3: 2}),
                    ),
                    Parameter(
                        Tiling(
                            (
                        ...
                        RowColMap({0: 0, 1: 0, 2: 1, 3: 2}, {0: 0, 1: 1, 2: 2, 3: 2}),
                    ),
                ),
            ),
            (),
