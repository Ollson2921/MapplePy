...
def all_cperms_mappling():
    ...
    return MappedTiling(all_cperms_tiling, ParameterList([]), ParameterList([]), ParameterList([]))


@pytest.fixture
def empty_mappling():
    return MappedTiling(Tiling.empty_tiling(), ParameterList([]), ParameterList([]), ParameterList([]))
